...
import { getDetailMovie, getMovieReviews, getMovieVideos } from "./redux/actions/movieAction";
      ...
      <div className="bg-no-repeat bg-white-auto justify-around w-full">
        <div className="text-white relative" key={movieDetail?.id}>
          ...
          <div className="absolute top-64 left-8 p-4">
            <h2 className="text-7xl font-semibold mb-2">{movieDetail?.title}</h2>
          </div>
        </div>
      </div>
      <div
      ...
      >
        <div className="flex flex-1 pl-3">
          ...
          <div className="flex flex-col ml-4 pl-8  w-[800px] pt-10">
            ...
            <p className="text-lg mb-3  pb-3 w-[600px]">{movieDetail?.overview}</p>
            ...
            <div>
              ...
              <div style={{ overflowX: "auto" }}>
                <div style={{ display: "flex", flexDirection: "row" }}>
                  {movieVideos && movieVideos.results.map((video, i) => (
                    <div
                      key={video.id}
                      style={{
                        display: "flex",
            ...
            <div className="container card flex flex-row rounded-md">
              <div className="card-body pt-3 rounded-lg gap-2 overflow-x-auto">
                {movieReviews && movieReviews.results.map((review) => (
                  <div
                    key={review.id}
